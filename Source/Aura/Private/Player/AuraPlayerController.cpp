...
void AAuraPlayerController::ShowDamageNumber_Implementation(float DamageAmount, bool bBlockedHit, bool bCriticalHit, ACharacter* TargetCharacter)
{
...
void AAuraPlayerController::BeginPlay()
{
	...
	{
		//Substem will only exist on local player and will be null for other player's machines
